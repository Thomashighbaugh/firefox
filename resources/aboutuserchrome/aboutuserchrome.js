...
const { PREF_UPDATE_INTERVAL: c, PREF_NOTIFICATIONS_ENABLED: d } =
  ...
  { _ucUtils: f } = ChromeUtils.importESModule(
...
function Zr(e) {
  for (const n in Jr)
    if (Xr.call(Jr, n) && Xr.call(e, n)) {
      const e = Jr[n];
      console.warn(
        `[react-markdown] Warning: please ${e.to ? `use \`${e.to}\` instead of` : "remove"} \`${n}\` (see <https://github.com/remarkjs/react-markdown/blob/main/changelog.md#${e.id}> for more info)`,
      ),
        delete Jr[n];
    }
  const t = ge()
...
((po = ho).__esModule = !0), (po.default = po);
var go = po.default,
  mo = {},
  bo = po.default;
((mo = function (e, n) {
...
((yo = vo).__esModule = !0), (yo.default = yo);
u = l("fYo6y");
function ko(e, n) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
  ...
  if (d) {
    ...
    if (a) {
      ...
      p = xo(
        ...
        {},
        {
          className: Co(b) || void 0,
          style: Eo(s.className, Object.assign({}, s.style, l), r),
        },
      );
    } else p = xo(xo({}, s), {}, { className: Co(s.className) });
    var y = h(t.children);
    return n(u).createElement(d, n(yo)({ key: i }, p), y);
  }
}
var Lo = [
  "language",
...
function Ro(e) {
  ...
  return (
    d & c && (f.style = To(To({}, f.style), {}, { display: "flex" })),
...
function Do(e) {
  for (
    ...
    var l = e[o];
    if ("text" === l.type)
      r.push(Ro({ children: [l], className: n(oo)(new Set(t)) }));
    else if (l.children) {
      var a = t.concat(l.properties.className);
      Do(l.children, a).forEach(function (e) {
        return r.push(e);
      });
    }
  }
          ...
          if (0 === o) {
            var s = m(
              c
                .slice(f + 1, p)
                .concat(
                  Ro({ children: [i], className: e.properties.className }),
                ),
              a,
            );
            d.push(s);
            ...
            if (u) {
              var g = Ro({ children: [h], className: e.properties.className });
              c.splice(p + 1, 0, g);
            } else {
      ...
      : "object" == typeof self
        ...
        : "object" == typeof window
          ...
          : "object" == typeof t
            ...
            : {},
  Ho =
    ((qo = (Uo = "Prism" in Bo) ? Bo.Prism : void 0),
    function () {
      Uo ? (Bo.Prism = qo) : delete Bo.Prism, (Uo = void 0), (qo = void 0);
    });
Bo.Prism = { manual: !0, disableWorkerMessageHandler: !0 };
var $o = {};
$o = l("4xIeY");
var Vo,
  Wo = {};
...
(Zo = function (e) {
  var n,
    t = "&" + e + ";";
  return (
    ((Jo = Jo || document.createElement("i")).innerHTML = t),
    (59 !== (n = Jo.textContent).charCodeAt(n.length - 1) || "semi" === e) &&
      n !== t &&
      n
  );
}),
  (Wo = function (e, n) {
    var t,
      ...
      o = {};
    n || (n = {});
    for (r in rl) (t = n[r]), (o[r] = null == t ? rl[r] : t);
    ...
    return (function (e, n) {
      ...
      for (; ++O < F; )
        if ((10 === a && (R = P[_] || 1), 38 === (a = e.charCodeAt(O)))) {
          ...
          for (
            ...
            (l += nl(s)), g === ol && el.call(Vo, l) && ((t = l), (f = Vo[l]));
          (o = 59 === e.charCodeAt(k)) &&
            (k++, (r = g === ol && Zo(l)) && ((t = l), (f = r))),
            (v = 1 + k - h),
            (o || w) &&
              (l
                ? g === ol
      ...
      function M(e, n) {
        var t = z();
        (t.column += n), (t.offset += n), C.call(A, ul[e], t, e);
      }
      function U() {
...
(ul[1] = "Named character references must be terminated by a semicolon"),
  (ul[2] = "Numeric character references must be terminated by a semicolon"),
  (ul[3] = "Named character references cannot be empty"),
  (ul[4] = "Numeric character references cannot be empty"),
  (ul[5] = "Named character references must be known"),
  (ul[6] = "Numeric character references cannot be disallowed"),
  (ul[7] =
...
(ml = bl), (bl.displayName = "css"), (bl.aliases = []);
var yl;
function vl(e) {
  e.languages.clike = {
    comment: [
...
(yl = vl), (vl.displayName = "clike"), (vl.aliases = []);
var kl;
function xl(e) {
...
(kl = xl), (xl.displayName = "javascript"), (xl.aliases = ["js"]), Ho();
var wl = {}.hasOwnProperty;
function Sl() {}
Sl.prototype = fl;
var El = new Sl();
function Cl(e) {
  ...
  void 0 === El.languages[e.displayName] && e(El);
}
(Mo = El),
  (El.highlight = function (e, n) {
    ...
    if ("Object" === El.util.type(n)) (t = n), (n = null);
    else {
      if ("string" != typeof n)
        throw new Error("Expected `string` for `name`, got `" + n + "`");
      if (!wl.call(El.languages, n))
  ...
  (El.registered = function (e) {
    ...
    return wl.call(El.languages, e);
  }),
  (El.listLanguages = function () {
    var e,
      n = El.languages,
      t = [];
    for (e in n) wl.call(n, e) && "object" == typeof n[e] && t.push(e);
    return t;
  }),
  Cl(hl),
  Cl(ml),
  ...
  (El.Token.stringify = function (e, n, t) {
    var r;
    if ("string" == typeof e) return { type: "text", value: e };
    if ("Array" === El.util.type(e))
      return (function (e, n) {
        var t,
          r = [],
          o = e.length,
        ...
        (l = -1), (o = r.length);
        for (; ++l < o; ) (t = r[l]), (r[l] = El.Token.stringify(t, n, r));
        return r;
      })(e, n);
    (r = {
      type: e.type,
      content: El.Token.stringify(e.content, n, t),
      tag: "span",
...
var Nl,
  ...
  Al =
    ...
    function (e) {
      ...
      var B = Io(q, w, N, h, m, y, q.value.length + y, x, E);
      return n(u).createElement(
        T,
        M,
        n(u).createElement(
...
(Al.registerLanguage = function (e, t) {
  return n(Mo).register(t);
}),
  (Al.alias = function (e, t) {
    return n(Mo).alias(e, t);
  });
var Tl,
  Pl = Al,
  Fl = {
...
(Tl = _l), (_l.displayName = "bash"), (_l.aliases = ["shell"]);
var Rl,
  Dl = n(Tl);
function Il(e) {
  !(function (e) {
...
(Rl = Il), (Il.displayName = "powershell"), (Il.aliases = []);
var jl,
  zl = n(Rl),
  Ml = n(ml);
function Ul(e) {
...
(jl = Ul), (Ul.displayName = "diff"), (Ul.aliases = []);
var ql,
  Bl = n(jl);
function Hl(e) {
  e.languages.ini = {
...
(ql = Hl), (Hl.displayName = "ini"), (Hl.aliases = []);
var $l,
  Vl = n(ql);
function Wl(e) {
  !(function (e) {
...
($l = Wl), (Wl.displayName = "regex"), (Wl.aliases = []);
var Gl,
  Ql = n($l),
  Yl = n(kl);
function Kl(e) {
...
(Gl = Kl), (Kl.displayName = "json"), (Kl.aliases = ["webmanifest"]);
var Xl,
  Jl = n(Gl);
function Zl(e) {
  !(function (e) {
...
(Xl = Zl), (Zl.displayName = "yaml"), (Zl.aliases = ["yml"]);
const na = ({ description: e, prefix: n = "" }) => {
  const t = (0, u.useRef)(),
    [r, o] = (0, u.useState)(!0),
    [l, i] = (0, u.useState)(!0),
    [s, c] = (0, u.useState)(
  ...
  return (
    ...
    (0, a.jsxs)("div", {
      className: `${n}description-wrapper ${r ? `${n}description-collapse` : ""}`,
      children: [
        (0, a.jsx)("div", {
...
new Map([
  [Dl, ["bash", "sh", "shell"]],
  [zl, ["powershell", "ps", "PS", "ps1", "PS1"]],
  [Ml, ["css", "CSS"]],
  [Bl, ["diff", "DIFF", "patch"]],
  [Vl, ["ini", "INI", "conf", "cfg", "config"]],
  [Ql, ["regex", "REGEX", "regexp"]],
  [Yl, ["javascript", "js", "JS"]],
  [Jl, ["json", "JSON", "json5", "JSON5"]],
  [n(Xl), ["yaml", "YAML", "yml", "YML"]],
  [
    n(hl),
    [
      "markup",
  ...
  Pl.registerLanguage(e[0], n), Pl.alias(e[0], e.slice(1));
});
const ra = ({ script: e, launchLocalFile: n }) => {
    let {
      author: t,
      authorURL: r,
      homepageURL: o,
          ...
          (0, a.jsxs)("div", {
            ...
            children: [
              ...
              (0, a.jsx)("a", {
                ...
                href:
                  e.updateURL &&
                  (ta(e.updateURL) ? e.updateURL : `file:///${e.updateURL}`),
          ...
          (0, a.jsxs)("div", {
            ...
            children: [
              ...
              (0, a.jsx)("a", {
                ...
                href:
                  e.optionsURL &&
                  (ta(e.optionsURL) ? e.optionsURL : `file:///${e.optionsURL}`),
  ...
  { gScriptUpdater: oa } = ChromeUtils.importESModule(
    "chrome://userchrome/content/aboutuserchrome/modules/UCMSingletonData.sys.mjs",
  ),
  { _ucUtils: la } = ChromeUtils.importESModule(
    "chrome://userchromejs/content/utils.sys.mjs",
  ),
  aa = ({
    script: e,
    ...
    const { navigate: i } = (0, u.useContext)(v),
      [s, c] = (0, u.useState)(!0),
      [d, f] = (0, u.useState)("info"),
      [p, h] = (0, u.useState)(""),
      [g, m] = (0, u.useState)(!1),
      [b, y] = (0, u.useState)(""),
      [k, x] = (0, u.useState)(!e.icon),
      [w, S] = (0, u.useState)(!1),
      E = (0, u.useRef)(null);
    let C = (0, u.useMemo)(() => oa.getHandle(e), []),
      N = (0, u.useMemo)(
        () => e.id.toLowerCase().replace(/[^a-z0-9_-]/g, "_"),
        [e.id],
      ),
      L = (0, u.useMemo)(() => `script-card-${N}`, [N]),
      A = (0, u.useMemo)(() => `script-name-${N}`, [N]),
      T = (0, u.useMemo)(
        () =>
    ...
    const P = (0, u.useCallback)(
      ...
      F = (0, u.useMemo)(() => {
        if (!r) return null;
        let e = r.name?.map(P).filter(Boolean);
        if (e?.length) return e;
        let n = r.filename?.map(P).filter(Boolean);
      ...
      U = (0, u.useCallback)(
        (e) => {
          C.launchLocalFile(), e.preventDefault();
        },
        [C],
      ),
      q = (0, u.useCallback)(() => la.toggleScript(e.filename), [e.filename]),
      B = (0, u.useCallback)(
        (e) => {
          let n = (
              e.remoteFile
                ? la.parseStringAsScriptInfo(e.filename, e.remoteFile)
                : {}
            ).version,
            t = {};
          e.writing
    ...
    return (
      ...
      (0, u.useEffect)(() => {
        t &&
          w &&
          (E.current?.blur(), document.querySelector(".back-button").focus());
      }, [t, w]),
      (0, u.useEffect)(() => {
        S(document.activeElement === E.current);
      }, [t]),
      (0, a.jsxs)("div", {
        id: L,
        ...
        children: [
                    ...
                    children: [
                      (0, a.jsx)("button", {
                        ...
                        children: (0, a.jsx)("h3", {
                          ...
                          title: `${e.filename}${e.version ? ` ${e.version}` : ""}`,
                          "aria-label": `${e.name || e.filename}${n ? "" : " (disabled)"}`,
                          children: F || e.name || e.filename,
                        }),
                      }),
                      (0, a.jsx)("div", {
              ...
              children: [
                ...
                (0, a.jsxs)("span", {
                  ...
                  children: [
                    ...
                    (0, a.jsx)("button", {
                      className: "update-button " + (g ? "" : "primary"),
                      disabled: g,
                      onClick: C.updateScript,
                      children: b,
                    }),
                  ],
                }),
          ...
          t ? (0, a.jsx)(ra, { script: e, launchLocalFile: U }) : null,
        ],
      })
    );
  },
  ia = ({ description: e, linkText: n, linkURL: t }) =>
    e
      ? (0, a.jsx)("div", {
  ...
  sa = ({
    ...
    return (
      e || n
        ? ((o.description = `fx-autoconfig is ${e ? "not installed" : "outdated"}.`),
        ...
        e.every((e) => e.disabled)
          ? e.some((e) => e.writing)
            ...
            : e.some((e) => e.pendingRestart)
              ? (y(!0), E(!1))
              : (m(!0),
                x("Update failed — Try updating manually"),
                y(!1),
                E(!0))
...
const da = ({ id: e, value: n, suffix: t, ...r }) => {
  ...
  fa = ({
    ...
    return (
      (0, u.useEffect)(() => {
        ...
        e < n
          ? (m(`Must be at least ${ca(n)}`), o?.(e))
          : e > t
            ? (m(`Must be at most ${ca(t)}`), o?.(e))
            : (m(null), r(e));
      }, [s, d, t, n, p, r, o]),
      (0, a.jsxs)(a.Fragment, {
        children: [
  ...
  { PREF_UPDATE_INTERVAL: pa, PREF_NOTIFICATIONS_ENABLED: ha } =
    ChromeUtils.importESModule(
      "chrome://userchrome/content/aboutuserchrome/modules/UCMSingletonData.sys.mjs",
    ),
  ga = () => {
...
const ba = () => {
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [
      ...
      (0, a.jsx)("div", {
        id: "content",
        children: { scripts: (0, a.jsx)(ua, {}), settings: (0, a.jsx)(ga, {}) }[
          e.split("/")[0]
        ],
      }),
    ],
...
(history.scrollRestoration = "manual"),
  console.log(`UserChrome Manager v${ma.version}`),
  i(document.getElementById("root")).render(
    (0, a.jsx)(x, { children: (0, a.jsx)(ba, {}) }),
  );
