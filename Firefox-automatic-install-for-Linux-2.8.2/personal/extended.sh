...
mkdir /home/$USER/Mozilla/firefox-esr ;
# Extracts to install path.
tar xjf FirefoxESR.tar.bz2 -C /home/$USER/Mozilla/firefox-esr/ ;
...
Exec=/home/$USER/Mozilla/firefox-esr/firefox/firefox %u --class FirefoxESR
...
Name[zh_CN]=新建窗口
Name[zh_TW]=開新視窗
Exec=/home/$USER/Mozilla/firefox-esr/firefox/firefox --new-window %u --class FirefoxESR
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗
Exec=/home/$USER/Mozilla/firefox-esr/firefox/firefox --private-window %u --class FirefoxESR" > Firefox-ESR.desktop ;
# Give time for icon script to complete.
sleep 2;
# Makes icon executable allowing it to run Firefox (which is also executable).
chmod +x Firefox-ESR.desktop ;
# Adds icon to application menu (xfce, gnome, cinnamon, mate, deepin, etc...).
cp Firefox-ESR.desktop /home/$USER/.local/share/applications/ ;
