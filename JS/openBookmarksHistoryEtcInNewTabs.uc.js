    ...
    if (window.HistoryMenu) {
      ...
      if (!proto._hasBeenModifiedForOBHNT) {
        proto._onCommand = function (e) {
          ...
          if (placesNode) {
            if (!PrivateBrowsingUtils.isWindowPrivate(window)) PlacesUIUtils.markPageAsTyped(placesNode.uri);
        ...
        proto._onClick = function (e) {
          let modifKey = AppConstants.platform == "macosx" ? e.metaKey || e.shiftKey : e.ctrlKey || e.shiftKey;
          if (e.button == 2 || (e.button == 0 && !modifKey)) return;
          let target = e.originalTarget;
          let tag = target.tagName;
          if (PlacesUIUtils.openInTabClosesMenu && (tag == "menuitem" || tag == "menu")) closeMenus(e.target);
        ...
        proto._onMouseUp = function (e) {
          ...
          if (modifKey || e.button == 1) {
            ...
            menupopup.addEventListener("popuphidden", () => target.removeAttribute("closemenu"), { once: true });
