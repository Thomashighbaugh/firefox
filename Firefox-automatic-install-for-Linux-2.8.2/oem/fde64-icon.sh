...
Exec=/opt/firefox-developer-edition/firefox/firefox %u --class FirefoxDeveloperEdition
Icon=/opt/firefox-developer-edition/firefox/browser/chrome/icons/default/default128.png
Terminal=false
Type=Application
...
Name[zh_CN]=新建窗口
Name[zh_TW]=開新視窗
Exec=/opt/firefox-developer-edition/firefox/firefox --new-window %u --class FirefoxDeveloperEdition
