...
(function () {
  class AutoHideHandler {
    ...
    get mainPopupSet() {
      return (
        this._mainPopupSet ||
        (this._mainPopupSet = document.getElementById("mainPopupSet"))
      );
    }
    get backButton() {
      return (
    ...
    get fwdButton() {
      return (
        this._fwdButton ||
        (this._fwdButton = document.getElementById("forward-button"))
      );
    }
    handleEvent(event) {
      ...
      switch (event.type) {
        case "popupshowing":
          ...
          break;
        case "popuphiding":
          if (popNode?.closest("panel") || popNode?.closest("menupopup"))
            return;
