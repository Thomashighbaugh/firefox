...
mkdir /home/$USER/Mozilla/firefox-developer-edition ;
# Extracts to install path
tar xjf FirefoxDeveloperEdition.tar.bz2 -C /home/$USER/Mozilla/firefox-developer-edition/ ;
...
Exec=/home/$USER/Mozilla/firefox-developer-edition/firefox/firefox %u --class FirefoxDeveloperEdition
Icon=/home/$USER/Mozilla/firefox-developer-edition/firefox/browser/chrome/icons/default/default128.png
Terminal=false
Type=Application
...
Name[zh_CN]=新建窗口
Name[zh_TW]=開新視窗
Exec=/home/$USER/Mozilla/firefox-developer-edition/firefox/firefox --new-window %u --class FirefoxDeveloperEdition
...
Name[zh_CN]=新建隐私浏览窗口
Name[zh_TW]=新增隱私視窗
Exec=/home/$USER/Mozilla/firefox-developer-edition/firefox/firefox --private-window %u --class FirefoxDeveloperEdition" > Firefox-Developer-Edition.desktop ;
# Give time for icon script to complete.
sleep 2;
# Makes icon executable allowing it to run Firefox (which is also executable).
chmod +x Firefox-Developer-Edition.desktop ;
# Adds icon to application menu (xfce, gnome, cinnamon, mate, deepin, etc...).
cp Firefox-Developer-Edition.desktop /home/$USER/.local/share/applications/ ;
