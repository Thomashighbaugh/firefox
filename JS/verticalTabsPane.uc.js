        ...
        constructor() {
            ...
            this.contextMenu._menuitemPosition = this.contextMenu.appendChild(
                create(document, "menuitem", {
                    ...
                    oncommand: `Services.prefs.setBoolPref(SidebarUI.POSITION_END_PREF, true);`,
                })
            );
            ...
            prefSvc.addObserver(SidebarUI.POSITION_END_PREF, this);
            ...
            SessionStore.promiseInitialized.then(() => {
                ...
                readPref(SidebarUI.POSITION_END_PREF);
