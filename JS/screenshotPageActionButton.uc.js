  ...
  class ScreenshotAction {
    constructor() {
      ...
      this.muObserver = new MutationObserver(async function (mus) {
        ...
        const shortcut = !!key_screenshot ? ` (${ShortcutUtils.prettifyShortcut(key_screenshot)})` : "";
    ...
    onCommand(_e, buttonNode) {
      if (buttonNode === this.node) {
        ...
        if (this.SCREENSHOT_BROWSER_COMPONENT) obs.notifyObservers(buttonNode.ownerGlobal, "menuitem-screenshot");
